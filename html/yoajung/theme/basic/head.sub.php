...
// `ssh 커스텀 CSS
// add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_URL.'/css/aos.css">');
...
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_URL.'/css/ssh_6.css">');
...
?>
<!-- `ssh CDN -->
<script src="https://kit.fontawesome.com/f3455f3758.js" crossorigin="anonymous"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css"/>
<script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>

<!-- `ssh 커스텀 JS -->
<script src="<?php echo G5_THEME_URL?>/js/aos.js"></script>
<!-- <script defer src="<?php echo G5_THEME_URL?>/js/ssh.js"></script> -->
<script defer src="<?php echo G5_THEME_URL?>/js/ssh_main.js"></script>
